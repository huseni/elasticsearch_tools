...
#######################################################################################################################
#                                                                                                                     #
# THIS SCRIPT IS TO CHECK THE STATUS OF ELASTIC SERVICES KIBANA AND CAN START STOP, RESTART OR RETURN THE STATUS      #
# OF THE SERVICE.                                                                                                     #
#                                                                                                                     #
...
# V. 1.0                                                                                                              #
# USAGE:                                                                                                              #
#       kibana_service_operations.py "start"                                                                          #
#       kibana_service_operations.py "stop"                                                                           #
#       kibana_service_operations.py "restart"                                                                        #
#       kibana_service_operations.py "status"                                                                         #
#                                                                                                                     #
#######################################################################################################################
import sys
import subprocess
...
def main():
    ...
    :return:
    """
    # 'kibana' service related parameters. This can be modify if you want to reuse this class for the filebeat, kibana and logstash or even any other standard linux utility services.
    elastic_service = "kibana"  # This parameter value has to be the service name that you have running on the EC2 instance
