...
#######################################################################################################################
#                                                                                                                     #
# THIS SCRIPT IS TO CHECK THE STATUS OF ELASTIC SERVICE ELASTICSEARCH AND CAN START STOP, RESTART OR RETURN THE STATUS      #
# OF THE SERVICE.                                                                                                     #
#                                                                                                                     #
...
# V. 1.0                                                                                                              #
# USAGE:                                                                                                              #
#       elasticsearch_service_operations.py "start"                                                                   #
#       elasticsearch_service_operations.py "stop"                                                                    #
#       elasticsearch_service_operations.py "restart"                                                                 #
#       elasticsearch_service_operations.py "status"                                                                  #
#                                                                                                                     #
#######################################################################################################################
import sys
import subprocess
